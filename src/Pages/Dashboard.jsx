                    ...
                    <div className='col-md-10'>
                        <div className='dashboard'>              
                            <div className='mb-3 p-3 flex-column text-center fs-5 pt-5 pb-5'>
                                ...
                                <div>
                                    <p>To get started on your first campaign, just select a template, update its content, and your <br /> email is ready to go. Export it to the ESP of your choice.</p>
                                </div>
                                <div className='d-flex justify-content-around mt-5'>
                                    <Link to={'/newtemplate'} style={{ textDecoration: 'none', color: 'black' }}>
                                        <div className="selectTemplate text-center border rounded ms-5 me-4 p-4">
                                            <div>
